...
public class AlertsTests extends TestUtilities {
	...
	public void jsAlertTest() {
		...
		// assertAll() must be added at the end, otherwise test never failes
	...
	public void jsPromptTest() {
		...
		// Verifications
		// 1 - Alert text is expected
		softAssert.assertTrue(alertMessage.equals("I am a JS prompt[Failed]"),
				"Alert message is not expected. \nShould be 'I am a JS prompt[Failed] ', but it is '" + alertMessage + "'");
